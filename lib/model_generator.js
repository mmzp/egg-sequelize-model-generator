                        ...
                        for (let field of fields) {
                            if (field.name) {
                                ...
                                if (field.default_value !== undefined) {
                                    if (utils.getJsType(dataType.type) === 'number') {
                                        fieldDefine.defaultValue = field.default_value;
                                    } else if (
                                        ['DATETIME', 'TIMESTAMP'].includes(dataType.type) &&
                                        field.default_value.toUpperCase() === 'CURRENT_TIMESTAMP'
                                    ) {
                                        fieldDefine.defaultValue = 'NOW';
                                        sequelizeDataTypes.push('NOW');
                                    } else if (field.allow_null && field.default_value.toUpperCase() === 'NULL') {
                                        fieldDefine.defaultValue = null;
                                    } else {
